...
var ZRComponent = (function () {
    ...
    ZRComponent.hideModalBox = function () {
        ...
        var targetId = '#' + ($(window.event.target).parent().hasClass('model-box-wrap') ? $(window.event.target).parent().attr('id') : $(window.event.target).parent().parent().attr('id'));
    ...
    ZRComponent.createAlert = function (args) {
        ...
        var okButtonFun = (args && args.okbtnFn) ? args.okbtnFn : function () {
            ZRComponent.hideModalBox();
        };
        var okButtonArg = (args && args.okbtnArg) ? args.okbtnArg : undefined;
        var closeFun = (args && args.closeFn && typeof args.closeFn === 'function') ? args.closefn : function () {
            ZRComponent.hideModalBox();
        };
    ...
    ZRComponent.createConfirm = function (args) {
        ...
        var cancelButtonFun = (args && args.cancelButtonFun) ? args.cancelButtonFun : function () {
            ZRComponent.hideModalBox();
        };
